...
/**
 * Transformer for X-Ray vision. Allows non-fluidic blocks to be made invisible.
 * 
 * @author Tulir293
 * @since 0.1
 * @from Maucros
...
public class BlockModelRendererT extends AbstractMauTransformer {
	...
	public byte[] transform(byte[] bytes, boolean obf) {
		String methodName = obf ? "a" : "renderModel";
		...
		String bmC = obf ? "cxe" : "net/minecraft/client/resources/model/IBakedModel";
		String wmC = obf ? "civ" : "net/minecraft/client/renderer/WorldRenderer";
		String desc = "(L" + baC + ";L" + bmC + ";L" + bsC + ";L" + bpC + ";L" + wmC + ";Z)Z";

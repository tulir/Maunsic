...
public class SliderVanilla extends Slider {
	...
	public void draw(int mx, int my) {
		...
		drawTexturedModalRect(x + (int)(value * (width - 8.0F)), y, 0, 66, 4, 20);
		drawTexturedModalRect(x + (int)(value * (width - 8.0F)) + 4, y, 196, 66, 4, 20);
		drawCenteredString(mc.fontRendererObj, format.format(this), x + width / 2, y + (height - 8) / 2, (inBounds(mx,my)) ? 16777120 : 0xffffff);
	}
